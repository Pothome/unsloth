...
export const ru = {
  ...
  studio: {
    ...
    methods: {
      ...
      grpo: {
        label: "GRPO (RL)",
        hint: "Обучение с подкреплением по готовым функциям вознаграждения.",
        note: "RL",
      },
    },
    grpo: {
      settings: "Настройки GRPO",
      rewardFunctions: "Функции вознаграждения",
      rewardFunctionsLoading: "Загрузка функций вознаграждения...",
      expectedColumns: "Требуются столбцы датасета: {columns}",
      weight: "Вес",
      numGenerations: "Генераций на промпт",
      numGenerationsTooltip: "Сколько ответов генерируется и оценивается для каждого промпта. Должно делить размер батча x накопление градиента.",
      maxPromptLength: "Макс. длина промпта",
      maxPromptLengthTooltip: "Сколько токенов промпта сохраняется перед генерацией. Более длинные промпты обрезаются.",
      maxCompletionLength: "Макс. длина ответа",
      maxCompletionLengthTooltip: "Максимум токенов на один роллаут. Промпт и ответ вместе должны помещаться в контекст.",
      temperature: "Температура сэмплирования",
      temperatureTooltip: "Более высокие значения делают роллауты разнообразнее, что нужно GRPO, чтобы отличать хорошие ответы от плохих.",
      topP: "Top-p",
      topPTooltip: "Порог nucleus-сэмплирования для роллаутов.",
      beta: "Коэффициент KL (бета)",
      betaTooltip: "Насколько сильно эталонная модель удерживает политику. 0 полностью убирает KL-член.",
      generationBackend: "Бэкенд роллаутов",
    ...
    charts: {
      ...
      meanReward: "Среднее вознаграждение",
      step: "Шаг {step}",
