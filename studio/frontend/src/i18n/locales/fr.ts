...
export const fr = {
  ...
  studio: {
    ...
    methods: {
      ...
      grpo: {
        label: "GRPO (RL)",
        hint: "Apprentissage par renforcement avec des fonctions de récompense prédéfinies.",
        note: "RL",
      },
    },
    grpo: {
      settings: "Paramètres GRPO",
      rewardFunctions: "Fonctions de récompense",
      rewardFunctionsLoading: "Chargement des fonctions de récompense...",
      expectedColumns: "Nécessite la ou les colonnes du jeu de données : {columns}",
      weight: "Poids",
      numGenerations: "Générations par prompt",
      numGenerationsTooltip: "Nombre de complétions générées et notées par prompt. Doit diviser taille de lot x accumulation de gradient.",
      maxPromptLength: "Longueur max du prompt",
      maxPromptLengthTooltip: "Tokens du prompt conservés avant génération. Les prompts plus longs sont tronqués.",
      maxCompletionLength: "Longueur max de la complétion",
      maxCompletionLengthTooltip: "Nombre maximal de tokens générés par rollout. Le prompt et la complétion doivent tenir dans le contexte.",
      temperature: "Température d'échantillonnage",
      temperatureTooltip: "Des valeurs plus élevées diversifient les rollouts, ce dont GRPO a besoin pour distinguer les bonnes des mauvaises réponses.",
      topP: "Top-p",
      topPTooltip: "Seuil d'échantillonnage nucleus pour les rollouts.",
      beta: "Coefficient KL (bêta)",
      betaTooltip: "Force avec laquelle le modèle de référence retient la politique. 0 supprime totalement le terme KL.",
      generationBackend: "Backend de rollout",
