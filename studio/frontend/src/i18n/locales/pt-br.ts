...
export const ptBR = {
  ...
  studio: {
    ...
    methods: {
      ...
      grpo: {
        label: "GRPO (RL)",
        hint: "Aprendizado por reforço com funções de recompensa predefinidas.",
        note: "RL",
      },
    },
    grpo: {
      settings: "Configurações do GRPO",
      rewardFunctions: "Funções de recompensa",
      rewardFunctionsLoading: "Carregando funções de recompensa...",
      expectedColumns: "Precisa da(s) coluna(s) do conjunto de dados: {columns}",
      weight: "Peso",
      numGenerations: "Gerações por prompt",
      numGenerationsTooltip: "Quantas respostas são geradas e pontuadas por prompt. Deve dividir o tamanho do lote x acumulação de gradiente.",
      maxPromptLength: "Comprimento máximo do prompt",
      maxPromptLengthTooltip: "Tokens do prompt mantidos antes da geração. Prompts maiores são truncados.",
      maxCompletionLength: "Comprimento máximo da resposta",
      maxCompletionLengthTooltip: "Máximo de tokens gerados por rollout. Prompt mais resposta precisam caber no contexto.",
      temperature: "Temperatura de amostragem",
      temperatureTooltip: "Valores maiores tornam os rollouts mais diversos, o que o GRPO precisa para separar boas de más respostas.",
      topP: "Top-p",
      topPTooltip: "Limite de amostragem nucleus para os rollouts.",
      beta: "Coeficiente KL (beta)",
      betaTooltip: "O quanto o modelo de referência puxa a política de volta. 0 remove o termo KL por completo.",
