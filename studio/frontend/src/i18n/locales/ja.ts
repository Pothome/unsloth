...
export const ja = {
  ...
  studio: {
    ...
    methods: {
      ...
      grpo: {
        label: "GRPO (RL)",
        hint: "プリセットの報酬関数による強化学習。",
        note: "RL",
      },
    },
    grpo: {
      settings: "GRPO 設定",
      rewardFunctions: "報酬関数",
      rewardFunctionsLoading: "報酬関数を読み込み中...",
      expectedColumns: "必要なデータセット列: {columns}",
      weight: "重み",
      numGenerations: "プロンプトあたりの生成数",
      numGenerationsTooltip: "各プロンプトに対して生成・採点する応答の数。バッチサイズ x 勾配累積を割り切る必要があります。",
      maxPromptLength: "最大プロンプト長",
      maxPromptLengthTooltip: "生成前に保持するプロンプトのトークン数。これを超える分は切り捨てられます。",
      maxCompletionLength: "最大生成長",
      maxCompletionLengthTooltip: "ロールアウトごとの最大生成トークン数。プロンプトと生成の合計がコンテキスト長に収まる必要があります。",
      temperature: "サンプリング温度",
      temperatureTooltip: "値を大きくするとロールアウトが多様になり、GRPO が良い応答と悪い応答を区別しやすくなります。",
      topP: "Top-p",
      topPTooltip: "ロールアウトの nucleus サンプリングのしきい値。",
      beta: "KL 係数 (beta)",
      betaTooltip: "参照モデルがポリシーをどれだけ引き戻すか。0 で KL 項を完全に無効化します。",
      generationBackend: "ロールアウトのバックエンド",
