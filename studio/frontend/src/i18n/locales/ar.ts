  ...
  settings: {
    ...
    resources: {
      ...
      modelMemory: {
        ...
        noRamReserveHint: "لا يحجز نسخة كاملة من الأوزان في ذاكرة النظام. يُبقي تحميل llama.cpp المعتمد على تعيين الذاكرة ويحذف ‎--no-mmap‎ و‎--mlock‎. يبقى التعيين نفسه قائماً، لذا تظل الصفحات التي يلمسها المُحمِّل محسوبة على هذه العملية حتى يستعيدها النظام.",
