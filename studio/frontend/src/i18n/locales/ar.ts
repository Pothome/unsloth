...
export const ar = {
  ...
  studio: {
    ...
    methods: {
      ...
      grpo: {
        label: "GRPO (RL)",
        hint: "تعلّم معزّز باستخدام دوال مكافأة جاهزة.",
        note: "RL",
      },
    },
    grpo: {
      settings: "إعدادات GRPO",
      rewardFunctions: "دوال المكافأة",
      rewardFunctionsLoading: "جارٍ تحميل دوال المكافأة...",
      expectedColumns: "يحتاج أعمدة مجموعة البيانات: {columns}",
      weight: "الوزن",
      numGenerations: "التوليدات لكل مطالبة",
      numGenerationsTooltip: "عدد الإكمالات التي تُولَّد وتُقيَّم لكل مطالبة. يجب أن يقسم حجم الدفعة x تراكم التدرّج.",
      maxPromptLength: "أقصى طول للمطالبة",
      maxPromptLengthTooltip: "رموز المطالبة المحفوظة قبل التوليد. تُقتطع المطالبات الأطول.",
      maxCompletionLength: "أقصى طول للإكمال",
      maxCompletionLengthTooltip: "أقصى عدد رموز مُولَّدة لكل جولة. يجب أن يتّسع المطالبة مع الإكمال داخل طول السياق.",
      temperature: "حرارة أخذ العينات",
      temperatureTooltip: "القيم الأعلى تجعل الجولات أكثر تنوّعًا، وهو ما يحتاجه GRPO لتمييز الإجابات الجيدة من السيئة.",
      topP: "Top-p",
      topPTooltip: "حدّ أخذ العينات النووي للجولات.",
      beta: "معامل KL (بيتا)",
      betaTooltip: "مدى شدّ النموذج المرجعي للسياسة إلى الخلف. القيمة 0 تزيل حدّ KL تمامًا.",
      generationBackend: "خلفية الجولات",
