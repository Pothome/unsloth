...
export const zhCN = {
  ...
  studio: {
    ...
    grpo: {
      settings: "GRPO 设置",
      rewardFunctions: "奖励函数",
      rewardFunctionsLoading: "正在加载奖励函数……",
      expectedColumns: "需要数据集列：{columns}",
      weight: "权重",
      numGenerations: "每个提示的生成数",
      numGenerationsTooltip: "为每个提示采样并打分的补全数量。必须能整除 批大小 x 梯度累积。",
      maxPromptLength: "最大提示长度",
      maxPromptLengthTooltip: "生成前保留的提示词元数，超出部分会被截断。",
      maxCompletionLength: "最大补全长度",
      maxCompletionLengthTooltip: "每次 rollout 生成的最大词元数。提示与补全之和必须放得下上下文长度。",
      temperature: "采样温度",
      temperatureTooltip: "数值越高 rollout 越多样，GRPO 需要这种多样性来区分好答案和坏答案。",
      topP: "Top-p",
      topPTooltip: "rollout 的核采样阈值。",
      beta: "KL 系数（beta）",
      betaTooltip: "参考模型把策略拉回的强度。设为 0 将完全去掉 KL 项。",
      generationBackend: "Rollout 后端",
