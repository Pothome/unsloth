...
def _ensure_uembed_offset_pooling(modules, num_eos_tokens, hidden_size, pooling_class):
    ...
    if isinstance(pooling, OffsetLastTokenPooling) and pooling.num_eos_tokens == num_eos_tokens:
        return
    ...
    def _apply_torch_compile(model, mode = "default"):
        ...
        while compile_candidate is not None:
            ...
            if config is None:
                ...
                is_qwen3_5 = class_name == "Qwen3_5Model" or class_name.startswith("Qwen3_5For")
            if is_qwen3_5:
                print(
